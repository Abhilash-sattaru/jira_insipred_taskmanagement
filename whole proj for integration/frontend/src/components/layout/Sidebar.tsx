...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    { to: '/dashboard', icon: LayoutDashboard, label: 'Dashboard', roles: ['ADMIN', 'MANAGER', 'DEVELOPER'] },
    { to: '/dashboard/tasks', icon: ListTodo, label: 'Tasks Board', roles: ['ADMIN', 'MANAGER', 'DEVELOPER'] },
    { to: '/dashboard/employees', icon: Users, label: 'Employees', roles: ['ADMIN', 'MANAGER'] },
    { to: '/dashboard/users', icon: UserCog, label: 'User Management', roles: ['ADMIN'] },
    { to: '/dashboard/analytics', icon: BarChart3, label: 'Analytics', roles: ['ADMIN', 'MANAGER'] },
    { to: '/dashboard/settings', icon: Settings, label: 'Settings', roles: ['ADMIN', 'MANAGER', 'DEVELOPER'] },
  ];
        ...
        <AnimatePresence mode="wait">
          {!collapsed && (
            ...
            >
              ...
              <div>
                <h1 className="font-bold text-sidebar-foreground text-sm">UST Employee</h1>
