...
const DashboardHome: React.FC = () => {
  ...
  const myTasks = tasks.filter((t) => empIdEquals(t.assigned_to, user?.e_id));
            ...
            <CardContent>
              <div className="space-y-3">
                {recentTasks.map((task, index) => {
                  // compute expected closure similar to TaskCard
                  ...
                  if (task.expected_closure) {
                    ...
                    expectedClosureDate = dateOnly
                      ...
                      : new Date(raw);
                    if (isNaN(expectedClosureDate.getTime()))
                      expectedClosureDate = null;
                  }
                  const isOverdue = expectedClosureDate
